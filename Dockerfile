...
### If downloadJdbcDrivers fails, download the jar file manually and uncomment the line below
...
RUN R -e "ref <- Sys.getenv('GIT_COMMIT_ID_ABBREV', unset=Sys.getenv('GIT_BRANCH')); remotes::install_github('OHDSI/ComparatorSelectionExplorer', ref=ref, update='always')"
